...
contract ERC721CryptoTestersTest is DSTest {
    ...
    function setUp() public {
        ...
        bytes32 root = bytes32(0x320d00a7b006cf53ef07d9d44030a767bd2703919199d3373c726f5322a3d7d8);

        // Deploy nft
        nft = new ERC721CryptoTesters('Cryptotesters', 'Testers', root, false, false);
    }
